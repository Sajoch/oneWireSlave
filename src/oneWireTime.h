...
public:
	...
	static constexpr timeOW_t SLOT_MAX = { 135 }; // should be 120, measured from falling edge to next falling edge

	// read and write from the viewpoint of the slave!!!!
	static constexpr timeOW_t READ_MIN = { 20 }; // should be 15, was 30, says when it is safe to read a valid bit
